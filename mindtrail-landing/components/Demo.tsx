...
export default function Demo() {
  ...
  return (
    <section id="demo" className="py-20 bg-gradient-to-b from-white to-gray-100">
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">See Mindtrail in Action</h2>
        ...
        <div className="relative rounded-xl overflow-hidden shadow-xl border border-gray-200">
          ...
          <button 
            className={`absolute inset-0 flex items-center justify-center bg-black/20 transition-opacity ${isPlaying ? 'opacity-0' : 'opacity-100'}`}
            onClick={togglePlay}
