  ...
  const availableFeatures = [
    {
      ...
      title: "Save selected tabs or entire window with one click",
      color: "text-blue-400"
    },
    {
      icon: (
      ...
      title: "Add notes and context to your saved sessions",
      color: "text-blue-400"
    },
    {
      icon: (
      ...
      title: "Easily find and restore past research sessions",
      color: "text-blue-400"
    },
    {
      icon: (
      ...
      title: "Resume exactly where you left off, anytime",
      color: "text-blue-400"
    }
  ];
  ...
  const comingSoonFeatures = [
    {
      ...
      title: "Auto-summarize content from your saved tabs",
      color: "text-blue-400"
    },
    {
      icon: (
      ...
      title: "Smart categorization of research by topic",
      color: "text-blue-400"
    },
    {
      icon: (
      ...
      title: "Get insights and connections across sessions",
      color: "text-blue-400"
    },
    {
      icon: (
      ...
      title: "Semantic search through all your saved research",
      color: "text-blue-400"
    }
  ];
